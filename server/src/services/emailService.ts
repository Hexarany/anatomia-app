  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <p style="margin-top: 20px; color: #666; font-size: 14px;">
        ${isRussian
          ? 'Вы также можете сдать задание через Telegram бот @mateevmassage_bot командой /submit'
          : 'De asemenea, puteți trimite tema prin botul Telegram @mateevmassage_bot folosind comanda /submit'}
      </p>
    </div>
    <div class="footer">
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <a href="https://t.me/mateevmassage_bot" class="button" style="background: #0088cc;">
